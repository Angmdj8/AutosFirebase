...
public class ListActivityPerson extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Autos registrados");
        ...
        db.collection("Documents").document(mPersonModelList.get(index).getId())
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(ListActivityPerson.this, "Auto eliminado", Toast.LENGTH_SHORT).show();
                        verDatos();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(ListActivityPerson.this, "Operación incompleta" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
